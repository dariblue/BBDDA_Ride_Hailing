...
GRANT ALL PRIVILEGES ON *.* TO 'admin_ridehailing'@'%' WITH GRANT OPTION;
...
GRANT SELECT, INSERT, UPDATE ON ridehailing.USER TO 'app_backend'@'%';
GRANT SELECT, INSERT, UPDATE ON ridehailing.RIDER_PROFILE TO 'app_backend'@'%';
GRANT SELECT, INSERT, UPDATE ON ridehailing.DRIVER_PROFILE TO 'app_backend'@'%';
GRANT SELECT, INSERT, UPDATE ON ridehailing.COMPANY TO 'app_backend'@'%';
GRANT SELECT, INSERT, UPDATE ON ridehailing.VEHICLE TO 'app_backend'@'%';
GRANT SELECT, INSERT, UPDATE ON ridehailing.TRIP TO 'app_backend'@'%';
GRANT SELECT, INSERT, UPDATE ON ridehailing.OFFER TO 'app_backend'@'%';
GRANT SELECT, INSERT, UPDATE ON ridehailing.PAYMENT TO 'app_backend'@'%';
...
GRANT SELECT, LOCK TABLES, SHOW VIEW, EVENT, TRIGGER ON ridehailing.* TO 'backup_user'@'localhost';
